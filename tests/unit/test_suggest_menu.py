...
class TestSuggestMenu:
    ...
    def test_suggest_menu_success_3_days(self, mock_bedrock, lambda_context, mock_dynamodb_recipes_table):
    ...
    @mock_dynamodb
    @patch('app.call_bedrock')
    def test_suggest_menu_success_7_days(self, mock_bedrock, lambda_context, mock_dynamodb_recipes_table):
    ...
    def test_suggest_menu_default_days(self, lambda_context):
        ...
        with patch('app.get_all_recipes') as mock_recipes, \
             patch('app.call_bedrock') as mock_bedrock:
    ...
    @mock_dynamodb
    @patch('app.call_bedrock')
    def test_suggest_menu_bedrock_error(self, mock_bedrock, lambda_context, mock_dynamodb_recipes_table):
    ...
    @mock_dynamodb
    @patch('app.call_bedrock')
    def test_suggest_menu_invalid_bedrock_json(self, mock_bedrock, lambda_context, mock_dynamodb_recipes_table):
    ...
    def test_suggest_menu_cors_headers(self, lambda_context):
        ...
        event = {
            'body': json.dumps({
                'days': 5  # Invalid to get quick response
            })
        }
...
class TestHelperFunctions:
    ...
    def test_get_recent_history(self, mock_dynamodb_history_table):
        ...
        mock_dynamodb_history_table.put_item(Item={
            'date': today,
            'recipes': ['recipe_001'],
            'meals': {}
        })
