...
class TestGetRecipes:
    ...
    def test_get_recipes_success(self, lambda_context, mock_dynamodb_recipes_table):
        ...
        mock_dynamodb_recipes_table.put_item(
            Item={"recipe_id": "recipe_002", "name": "卵焼き", "category": "副菜"}
        )
    ...
    def test_get_recipes_with_category_filter(
        ...
        mock_dynamodb_recipes_table.put_item(
            Item={"recipe_id": "recipe_003", "name": "ご飯", "category": "主食"}
        )

        event = {"queryStringParameters": {"category": "主食"}}
    ...
    def test_get_recipes_no_match_category(
        ...
        event = {"queryStringParameters": {"category": "存在しないカテゴリ"}}
    ...
    def test_decimal_to_float_conversion(self):
        ...
        assert result == {"values": [10, 20.5], "nested": {"inner": 30}}
