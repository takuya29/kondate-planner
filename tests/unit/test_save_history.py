...
class TestSaveHistory:
    ...
    def test_save_history_missing_recipe_name(self, lambda_context):
        ...
        event = {
            ...
            'body': json.dumps({
                ...
                'meals': {
                    'breakfast': [
                        {'recipe_id': 'recipe_001'}  # Missing name
                    ]
                }
            })
        }
    ...
    @mock_dynamodb
    def test_save_history_multiple_meals(self, lambda_context, mock_dynamodb_history_table):
...
class TestGetHistory:
    ...
    @mock_dynamodb
    def test_get_history_with_days_param(self, lambda_context, mock_dynamodb_history_table):
