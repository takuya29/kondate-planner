...
SAMPLE_HISTORY_ENTRIES = [
    {
        ...
        'recipes': ['recipe_001', 'recipe_002', 'recipe_003', 'recipe_004', 'recipe_005', 'recipe_006'],
        'notes': 'バランスの良い献立'
    },
    {
        'date': '2025-11-07',
        'meals': {
            ...
            'lunch': [
                {'recipe_id': 'recipe_007', 'name': 'カレーライス'}
            ],
            'dinner': [
...
INVALID_HISTORY_EMPTY_MEALS = {
    'date': '2025-11-08',
    'meals': {
        'breakfast': []  # Empty array not allowed
    }
}
